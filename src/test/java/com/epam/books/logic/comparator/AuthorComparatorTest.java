...
public class AuthorComparatorTest {
    private static final Book FIRST_BOOK = new Book(null, 0, "a", null);
    private static final Book SECOND_BOOK = new Book(null, 0, "b", null);
    private static final Book THIRD_BOOK = new Book(null, 0, "a", null);
